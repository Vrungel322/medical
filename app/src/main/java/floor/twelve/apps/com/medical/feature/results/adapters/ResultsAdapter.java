...
public class ResultsAdapter extends MvpBaseRecyclerAdapter<ResultsAdapter.ResultsViewHolder>
    implements IResultsAdapter {

  @InjectPresenter ResultsAdapterPresenter mPresenter;

  private Context mContext;
  private Navigator mNavigator;
  private ArrayList<ResultEntity> mResultEntities = new ArrayList<>();

  public ResultsAdapter(MvpDelegate<?> parentDelegate, Context context, Navigator navigator) {
    super(parentDelegate, "ResultsAdapterPresenter");
