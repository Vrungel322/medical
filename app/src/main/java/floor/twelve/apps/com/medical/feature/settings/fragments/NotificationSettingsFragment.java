...
import floor.twelve.apps.com.medical.feature.settings.views.INotificationSettingsFragmentView;
...
public class NotificationSettingsFragment extends BaseFragment
  ...
  @Override public void showPickHourDialog() {
    mPickHourDialog =
        new TimePickerDialog(new ContextThemeWrapper(getContext(), R.style.TimePickerDialogTheme),
            (timePicker, i, i1) -> {
            ...
            (int) (TimeUnit.MILLISECONDS.toMinutes(
                mNotificationSettingsFragmentPresenter.getHours()) - TimeUnit.HOURS.toMinutes(
